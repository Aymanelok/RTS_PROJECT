...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\smart_traffic\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\smart_traffic\hook\ament_prefix_path.bat"
